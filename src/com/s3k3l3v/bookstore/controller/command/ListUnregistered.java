...
public class ListUnregistered extends Command {
    private static final long serialVersionUID = 7732286214029478114L;

    private static final Logger LOG = Logger.getLogger(ListUnregistered.class);

    @Override
    public String execute(HttpServletRequest request,
                          HttpServletResponse response) throws IOException, ServletException, DBException, SQLException {

        LOG.debug("Command unregistered starts");
        ...
        return Path.PAGE_BOOK_LIST_UNREGISTERED;
    }
}
